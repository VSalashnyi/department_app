...
/* harmony import */ var _DepartmentAppView__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _DepartmentAppController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);


var departmentAppView = new _DepartmentAppView__WEBPACK_IMPORTED_MODULE_0__["DepartmentAppView"]();
var departmentApp = new _DepartmentAppController__WEBPACK_IMPORTED_MODULE_1__["DepartmentAppController"](departmentAppView);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepartmentAppView", function() { return DepartmentAppView; });
...
var DepartmentAppView =
/*#__PURE__*/
function () {
  function DepartmentAppView() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, DepartmentAppView);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(DepartmentAppView, [{
    key: "renderNavbar",
    value: function renderNavbar(data) {
      var _this = this;

      $('nav').empty();
      data.forEach(function (dep) {
        _this.renderButton(dep.department_title, 'btn btn-secondary m-3', 'nav', function () {
          return _this.windowHistoryPushState('/gfdsgdfg');
        });
      });
      this.renderButton('Add new department', 'btn btn-success m-3', 'nav', function () {
        _this.windowHistoryPushState('/add-department');
      });
    }
  }, {
    key: "render",
    ...
    value: function renderContent() {
      ...
      if (current_department === undefined) {
        ...
        this.renderButton('Delete department', 'btn btn-danger ml-5 mb-3', div, function () {
          state = state.filter(function (department) {
            return department !== current_department;
          });

          _this2.renderNavigation(state);

          if (state.length) {
            _this2.windowHistoryPushState(state[state.length - 1].id);

            _this2.render(window.location.pathname);
          } else {
            _this2.windowHistoryPushState('no-dep');

            _this2.render(window.location.pathname);
          }
        });
        this.renderButton('Edit department', 'btn btn-warning ml-5 mb-3', div, function () {
          _this2.windowHistoryPushState('edit-department');

          _this2.render(window.location.pathname);
        });
        $('<p/>').html("Head of department - <b>".concat(current_department.head, "</b>")).appendTo(div);
        $('<p/>').html("Average salary : ".concat(this.averageSalary(current_department))).appendTo(div);
        $('<p/>').html("Total salary : ".concat(this.totalSalary(current_department))).appendTo(div);
    ...
    key: "renderTableRow",
    value: function renderTableRow(employee) {
      var _this3 = this;
      ...
      this.renderButton('Delete', 'btn btn-danger', row, function () {
        state = state.map(function (dep) {
          if (dep === current_department) {
            var deletedEmployees = dep.employees.filter(function (currentEmployee) {
              return currentEmployee !== employee;
            });
            return _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0___default()({}, dep, {
        ...
        _this3.render(window.location.pathname);
      });
      this.renderButton('Edit', 'btn btn-warning mr-2', row, function () {
        current_employee = employee;

        _this3.windowHistoryPushState('edit-employee');
    ...
    key: "averageSalary",
    value: function averageSalary(_ref2) {
    ...
    key: "totalSalary",
    value: function totalSalary(_ref3) {
    ...
    key: "getSalary",
    value: function getSalary(employees) {
    ...
    value: function renderList() {
      ...
      current_department.employees.forEach(function (employee) {
        if (employee.salary < this.averageSalary(current_department)) {
          list.append($('<li>').text("".concat(employee.firstName, " ").concat(employee.secondName)));
          count++;
        }
      }.bind(this));
    ...
    key: "windowHistoryPushState",
    value: function windowHistoryPushState(data) {
    ...
    key: "renderButton",
    value: function renderButton(buttonTitle, buttonClass, appendPlace, callBack) {
    ...
    key: "renderDepartmentForm",
    value: function renderDepartmentForm() {
    ...
    key: "renderEmployeeForm",
    value: function renderEmployeeForm() {
      var div = $('<div/>').addClass('jumbotron w-50 m-auto');
      var form = $('<form/>').appendTo(div);
    ...
    key: "renderAddDepartmentForm",
    value: function renderAddDepartmentForm() {
    ...
    key: "renderEditDepartmentForm",
    value: function renderEditDepartmentForm() {
      renderDepartmentForm();
    ...
    key: "renderEditEmployeeForm",
    value: function renderEditEmployeeForm() {
      renderEmployeeForm();
      ...
      renderButton('Edit employee', 'btn btn-secondary float-right mt-3', 'form', function () {
        state = state.map(function (dep) {
          if (dep === current_department) {
            var editedEmployees = dep.employees.map(function (employee) {
    ...
    key: "renderAddEmployeeForm",
    value: function renderAddEmployeeForm() {
      renderEmployeeForm();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepartmentAppController", function() { return DepartmentAppController; });
...
/* harmony import */ var _getDepartments__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13);
...
var state;
var DepartmentAppController =
/*#__PURE__*/
function () {
  function DepartmentAppController(departmentAppView) {
    var _this = this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, DepartmentAppController);

    this.departmentAppView = departmentAppView;
    this.Route = {
      '/': function _() {
        return _this.renderDefaultPage();
      },
      '/add-employee': function addEmployee() {
        return _this.renderAddEmployeeForm('add-employee');
      },
      '/edit-employee': function editEmployee() {
        return _this.renderEditEmployeeForm('edit-employee');
      },
      '/add-department': function addDepartment() {
        return _this.renderAddDepartmentForm('add-dep');
      },
      '/edit-department': function editDepartment() {
        return _this.renderEditDepartmentForm('add-dep');
      }
    };
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(DepartmentAppController, [{
    key: "render",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return Object(_getDepartments__WEBPACK_IMPORTED_MODULE_4__["getDepartments"])();
    ...
    key: "renderAddDepartmentForm",
    value: function renderAddDepartmentForm(par) {
      // $('#app').html(`<div class="jumbotron"><h1 class="display-4"></h1></div>`).text('Choose department you are interesting in, or ad your own');
      //this.departmentAppView.renderParentDiv();
    ...
    key: "renderEditDepartmentForm",
    value: function renderEditDepartmentForm(par) {
      // $('#app').html(`<div class="jumbotron"><h1 class="display-4"></h1></div>`).text('Choose department you are interesting in, or ad your own');
      //this.departmentAppView.renderParentDiv();
  ...
  return DepartmentAppController;
}();
...
function _getDepartments() {
  _getDepartments = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var response, result;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch('http://www.mocky.io/v2/5c2ce2ee2e00004e06e877f1');
